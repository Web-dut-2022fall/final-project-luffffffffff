# Generated by Django 3.2.7 on 2022-03-23 06:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stated', models.CharField(blank=True, max_length=16, verbose_name='用户身份码')),
                ...
                ('uni_num', models.CharField(blank=True, max_length=64, verbose_name='住房所在楼栋的单元')),
                ('sex', models.CharField(max_length=8, null=True, verbose_name='性别')),
                ('mobile', models.CharField(max_length=16, null=True, unique=True, verbose_name='用户手机号')),
